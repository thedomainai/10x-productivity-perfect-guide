        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {phases.map((phase) => (
              ...
              >
                <span className="inline-block text-xs font-medium px-2.5 py-1 rounded bg-slate-50 text-slate-500 border border-slate-200 mb-3 group-hover:border-[#8fa5d4] group-hover:text-[#5068a4] group-hover:bg-[#eef1f8] transition-all duration-200">
                  {phase.phase}
                </span>
